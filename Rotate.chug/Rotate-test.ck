...
//    (the bulid process should yield a Rotate.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Rotate.chug Rotate-test.ck`
//
...
//    `chuck --chugin:Rotate.chug Rotate-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a Rotate
Rotate obj;
