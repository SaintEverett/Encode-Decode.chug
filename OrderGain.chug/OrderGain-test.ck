...
//    (the bulid process should yield a BFormat.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:BFormat.chug BFormat-test.ck`
//
...
//    `chuck --chugin:BFormat.chug BFormat-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a BFormat
BFormat obj;
