...
//    (the bulid process should yield a Encode.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Encode.chug Encode-test.ck`
//
...
//    `chuck --chugin:Encode.chug Encode-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a Encode
Encode obj;
