...
//    (the bulid process should yield a Decode.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:Decode.chug Decode-test.ck`
//
...
//    `chuck --chugin:Decode.chug Decode-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a Decode
Decode obj;
