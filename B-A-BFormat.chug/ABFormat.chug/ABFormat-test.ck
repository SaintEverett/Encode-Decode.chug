...
//    (the bulid process should yield a ABFormat.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:ABFormat.chug ABFormat-test.ck`
//
...
//    `chuck --chugin:ABFormat.chug ABFormat-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a ABFormat
ABFormat obj;
