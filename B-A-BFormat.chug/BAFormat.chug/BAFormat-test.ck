...
//    (the bulid process should yield a BAFormat.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:BAFormat.chug BAFormat-test.ck`
//
...
//    `chuck --chugin:BAFormat.chug BAFormat-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a BAFormat
BAFormat obj;
